...
<body>
	...
	<section>
		...
		<form action="" method="POST" class="form">
<!-- In the table section, replace the Order ID display with this: -->
<table class="table_displayData" style="margin-top:20px;">
    ...
    <?php 
    // Reset the result pointer to ensure we count all records
    mysqli_data_seek($result_selectOrder, 0);
    $totalOrders = mysqli_num_rows($result_selectOrder);
    $i = $totalOrders;
